  ...
  const features = [
    {
      name: "Free to host",
      description:
        "Instructions included for Cloudflare. Free to start, and cost effective to scale.",
...
<path d="M17.5 9.74145C17.7095 9.53198 18.0491 9.53198 18.2586 9.74145C18.468 9.95092 18.468 10.2905 18.2586 10.5C18.0491 10.7095 17.7095 10.7095 17.5 10.5C17.2905 10.2905 17.2905 9.95092 17.5 9.74145Z" fill="#1C274C"/>`,
    },
    {
      ...
      link: "#",
      description:
        "Pre-rendered pages, instant navigation, and optimized for 100/100 PageSpeed score.",
      svgContent: `<path d="M13 2L3 14H12L11 22L21 10H12L13 2Z" stroke="#1C274C" stroke-width="1.5" stroke-linejoin="round" fill="none"/>`,
    },
    {
      name: "Blog",
      link: "/blog",
...
<path d="M7 6H12" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    },
    {
      name: "Get Started",
      link: "/contact_us",
      description: "Ready to learn more? Contact us to discuss your needs.",
...
<path d="M11 13H2" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    },
    {
      ...
      description:
        "Tools you'll love working with, including SvelteKit, Tailwind, and DaisyUI.",
      linkText: "Docs",
      newPage: true,
